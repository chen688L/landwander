<template>
	<view>
		<view @tap="togglePopup('bottom','popup')" style="padding: 10rpx 40upx;display: flex;align-items: center;">
...
<script>
	import cityDatas from '../../utils/city.area.js'
	import uniPopup from './uni-pop.vue'
	export default {
		components: {
			uniPopup
		},
		...
		methods: {
			...
			setAddress(){
				let address = this.selectList[0].txt+'/'+this.selectList[1].txt+'/'+this.selectList[2].txt
				uni.setStorageSync('land_address',address)
				console.log(address);
			}
		}
	}
