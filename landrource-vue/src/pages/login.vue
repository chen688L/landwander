    ...
    <div class="container">
      ...
      <div class="login-box">
        <form>
          ...
          <div :class="focus === 1?'input-group focus':'input-group'" >
            <div class="icon">
              <i class="fa fa-user"></i>
            </div>
            <div>
              <h5>Cell phone</h5>
              <input v-model="phone" @blur="blurFunction" @focus="focusFunction(1)" type="text" class="input" />
            </div>
          </div>
          <div class="input-group" :class="focus === 2?'input-group focus':'input-group'" >
            <div class="icon">
              <i class="fa fa-lock"></i>
            </div>
            <div>
              <h5>Password</h5>
              <input v-model="password" @blur="blurFunction" @focus="focusFunction(2)" type="password" class="input" />
            </div>
          </div>
